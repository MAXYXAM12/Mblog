...
如果把前面所有内容压缩成几个核心变量，可以发现耳机换能器实际上一直在围绕下面几个量进行优化。
...
> **不能仅仅根据“动圈、平板、静电、动铁”来判断一副耳机的声音。**

同一种换能器内部，依然可以存在巨大的性能差异。
...
> **没有一种换能器能够同时在所有指标上取得最高值。**

这不是技术发展不够，而是物理规律本身决定了：
...
这也是现代耳机尤其是高端 IEM 的一个重要趋势。

与其寻找一个：

> “什么都做到最好”的换能器，

不如让不同换能器分别承担自己最擅长的工作。
