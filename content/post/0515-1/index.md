...
这两项在菜单栏里，笔者用得很少。前者是**卷积**功能，音箱房间校准可能会用到；后者是 EQ 功能以及 Crossfeed （交叉互馈），如果需要减少耳机头中效应可以试试 Crossfeed
...
当你理解 HQPlayer 的全部功能以及那些专有名词，并将其与主观听感挂钩之后，HQPlayer 就成为了一个稳定、可控、有限方向、几乎无成本的周边调整项；更进一步，你对于整套系统的优缺点会有更清晰的认知，对于如何升级大件来说减少了试错困难。